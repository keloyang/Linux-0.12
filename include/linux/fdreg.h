 ...
 */
/*
 * 该文件中含有一些软盘控制器的一些定义.这些信息有多处来源,大多数取自Sanches和Canton编著的<<IBM微型计算机:程序员手册>>一书.
 */
...
#define ST0_INTR	0xC0		/* Interrupt code mask */	// 中断代码位(中断原因),00 - 命令正常结束;
...
#define ST2_SNS		0x04		/* Scan Not Satisfied */	// 检索(扫描)条件不满号.
#define ST2_SEH		0x08		/* Scan Equal Hit */		// 检索条件满号
